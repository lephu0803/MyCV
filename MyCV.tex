...
I am a studious person who is eager to learn new things and ready to face of challenges. About one year working as an AI Engineer in industrial environment, I have obtained much experience in analyzing image data and handling issues by applying Computer Vision and Machine Learning knowledge. Now, I would like get in-depth and comprehensively understand the data instead of giving a try or depending on the state-of-the-art Deep Learning algorithms and fine-tuning the model without looking back the data. Therefore, I am seeking for a Data Scientist position to strengthen my working skills in Data Science, Machine Learning. Also, I would like to contribute my abilities to the company and my working team.

\smallskip
\cvsection{Experiences}

\cvevent{AI Engineer}{GE3F Pte. Ltd}{Aug. 2018 -- Present}{Ho Chi Minh City, Vietnam}
\justify
\begin{itemize}
\item 
